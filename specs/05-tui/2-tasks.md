...
1. [ ] Task 01 — Spec: Stories & Requirements
	- spec: `specs/05-tui/0-stories.md`, `specs/05-tui/1-requirements.md`
	...
	- acceptance: `0-stories.md` and `1-requirements.md` exist, include acceptance criteria for each user story, and list tests where required; ready for task generation.
...
2. [ ] Task 02 — CLI skeleton & parsing
	- spec: `specs/05-tui/1-requirements.md`
...
6. [ ] Task 06 — Implement `status` summary
	...
	- acceptance: `status` prints power state, set/measured voltage/current with timestamps; `status --json` conforms to the agreed schema in `1-requirements.md`.
...
9. [ ] Task 09 — Docs & CI
	- spec: `docs/` and `specs/05-tui/1-requirements.md`
...
References:
- Origin spec: `specs/05-tui/0-stories.md` and `specs/05-tui/1-requirements.md`.
