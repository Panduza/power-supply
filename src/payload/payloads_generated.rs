...
impl StatusCode {
  ...
  pub const Panicking: Self = Self(2);
...
impl<'a> Status<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.pza_id { builder.add_pza_id(x); }
  ...
  pub fn pza_id(&self) -> Option<&'a str> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Status::VT_PZA_ID, None)}
  }
  #[inline]
  pub fn code(&self) -> StatusCode {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<StatusCode>(Status::VT_CODE, Some(StatusCode::Booting)).unwrap()}
  }
  #[inline]
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> StatusBuilder<'a, 'b, A> {
  ...
  pub fn add_pza_id(&mut self, pza_id: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Status::VT_PZA_ID, pza_id);
  }
  #[inline]
  pub fn add_code(&mut self, code: StatusCode) {
    self.fbb_.push_slot::<StatusCode>(Status::VT_CODE, code, StatusCode::Booting);
  }
  #[inline]
...
impl<'a> Error<'a> {
  ...
  pub fn pza_id(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Error::VT_PZA_ID, None)}
  }
  #[inline]
  pub fn message(&self) -> Option<&'a str> {
    // Safety:
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ErrorBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_pza_id(&mut self, pza_id: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Error::VT_PZA_ID, pza_id);
  }
  #[inline]
  pub fn add_message(&mut self, message: flatbuffers::WIPOffset<&'b  str>) {
